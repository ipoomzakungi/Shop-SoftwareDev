...
import { userRequest, setToken, publicRequest } from "../../requestMethod"
...
`
const TopButtonVoid = styled.div`
    padding: 25px;
              ...
              <Product>
                <ProductDetail>
                  ...
                  <Details>
                    ...
                    <ProductID><b>Amount :</b> {order.amount} </ProductID>
